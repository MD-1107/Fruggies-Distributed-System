...
public class Client2 {
	public static void main(String[] args) {
	   ...
	   int client=2;
		 LoadBalancing roundRobin = new LoadBalancing();
		String HOST= roundRobin.getHost(client);
		// roundRobin.request_no++;
		// int PORT= roundRobin.getPort();
		...
		try {
			...
			int val=roundRobin.portSet(client);
			Socket s = new Socket("localhost", val);
            ...
            System.out.println("Client connected to the server "+HOST+val);

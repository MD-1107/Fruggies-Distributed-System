...
public class Server2 extends UnicastRemoteObject implements Interface {
	String fruits = "";
	int fruitIndex = 0;
	int vegIndex = 0;
	String fruits_quant = "";
	...
	public static void main(String[] args) {
		final String HOST = "rmi://localhost:1002//Server2";
		Server2 Server;
		...
		try {
			...
			LocateRegistry.createRegistry(1002);

			Naming.bind(HOST, Server);

			System.out.println("[+] Server bound to Registry succesfully");
			System.out.println("[+] Server Ready");
			System.out.println("Server is running at 1002");
			ServerSocket s = new ServerSocket(5052);
